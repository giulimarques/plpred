...
def generate_aa_composition_df(file_path:str, membrane_label:int) -> pd.DataFrame:
    """
    Generates a Pandas DataFrame with the aminoacid composition of a given set of proteins in a FASTA file

    Parameters
    ----------
    file_path: str
        path to the FASTA file containing the protein sequences to be processed
